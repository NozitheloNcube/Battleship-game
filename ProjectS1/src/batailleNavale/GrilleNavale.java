...
public class GrilleNavale {
	...
	public static void main(String[] args) {
		...
		System.out.print(g);
//		Navire n = new Navire(new Coordonnee(1, 2), 3, false);
//		Navire n1 = new Navire(new Coordonnee(2, 1), 3, true);
//		g.ajouteNavire(n1);
//		g.ajouteNavire(n);
//		Coordonnee c = new Coordonnee(0,1);
//		Coordonnee c1 = new Coordonnee(2,1);
//		Coordonnee c2 = new Coordonnee(3,1);
//		Coordonnee c3 = new Coordonnee(4,1);
//		g.recoitTir(c);
//		System.out.println(g.perdu());
//		g.recoitTir(c1);
//		g.recoitTir(c2);
//		System.out.println(g.estCoule(c2));
//		System.out.println(g.estALEau(c1));
//		System.out.println(g.estTouche(c2));
//		System.out.println(g.perdu());
//		g.recoitTir(c3);
//		System.out.println(g);
//		System.out.println(g.estALEau(c));
//		System.out.println(g.estCoule(c3));
//		System.out.println(g.estTouche(c3));
//		System.out.println(g.estALEau(c3));
//		System.out.println(g.perdu());
//		int []t = {3,2};
//		g.placementAuto(t);
//		System.out.print(g);
